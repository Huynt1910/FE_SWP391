      ...
      try {
        ...
        if (response && response.success === true) {
          ...
          if (
            ...
            console.log("Found token and role in result object:", {
              token: "Found",
              role: userRole,
            });
          }
          // Case 2: Token in result, roles in user object
            ...
            console.log("Found token in result, role in user object:", {
              token: "Found",
              role: userRole,
            });
          }
          // Case 3: Token and user in result
            ...
            console.log("Found token in result, no role specified:", {
              token: "Found",
              role: userRole,
            });
          }
          // Case 4: Token directly in result (string)
            ...
            userRole = "customer"; // Default to customer if no role specified
            console.log("Found token as string in result:", {
              token: "Found",
              role: userRole,
            });
          }
